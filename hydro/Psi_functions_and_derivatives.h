...
void set_PsiA_first_derivatives_vector()
{
...
void set_PsiA_second_derivatives_array()
{
	for (int iu = 0; iu < n_u_pts; ++iu)
	{
		double u = u_pts[iu];
...
void set_PsiBk_first_derivatives_vector()
{
	for (int iu = 0; iu < n_u_pts; ++iu)
	{
		double u = u_pts[iu];
...
void set_PsiBk_second_derivatives_array()
{
	for (int iu = 0; iu < n_u_pts; ++iu)
	{
		double Tf2 = Tf*Tf;
